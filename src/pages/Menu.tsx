        ...
        {items.map((item, i) => (
          ...
          >
            <motion.div
              ...
              className="p-4 rounded-xl border border-cream/5 bg-cream/[0.02] hover:bg-cream/[0.06] hover:border-gold/20 hover:shadow-[0_0_20px_rgba(212,175,55,0.08)] transition-colors duration-300 cursor-pointer h-full"
            >
