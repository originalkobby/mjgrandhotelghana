  ...
  const handleLookup = async () => {
    ...
    if (!mail) {
      toast({
        ...
        description: "Enter the email you used when booking to view your details.",
        variant: "destructive",
      });
      return;
    }
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-12 max-w-2xl">
          ...
          >
            ...
            <p className="text-xs text-muted-foreground">
              For your privacy, we require the email used when booking to confirm your identity.
            </p>
          </motion.div>
          ...
          {notFound && (
            ...
            >
              ...
              <p className="text-sm mt-2">Please check the reference and email and try again.</p>
            </motion.div>
          )}
